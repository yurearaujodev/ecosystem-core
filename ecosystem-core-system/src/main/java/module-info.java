module br.com.yat.ecosystemcore {
   ...
   // requires javafx.graphics;
    ...
    exports br.com.yat.ecosystemcore.modules.banco; 
    exports br.com.yat.ecosystemcore.core;
  ...
  //  opens br.com.yat.ecosystemcore.bootstrap to javafx.fxml;
    opens br.com.yat.ecosystemcore.menu to javafx.fxml;
    opens br.com.yat.ecosystemcore.core to javafx.fxml;
    opens br.com.yat.ecosystemcore.modules.empresa.ui to javafx.fxml;
    opens br.com.yat.ecosystemcore.modules.login to javafx.fxml;
    opens br.com.yat.ecosystemcore.modules.tenant to javafx.fxml;
    opens br.com.yat.ecosystemcore.modules.banco to javafx.fxml;
    
    // LIBERA A REFLEXÃO DO FXMLLOADER PARA OS SEUS CONTROLADORES
    opens br.com.yat.ecosystemcore.modules.system to javafx.fxml;
    opens br.com.yat.ecosystemcore.modules.home to javafx.fxml;
    opens br.com.yat.ecosystemcore.modules.pessoa.ui to javafx.fxml;
    opens br.com.yat.ecosystemcore.modules.perfil to javafx.fxml;
    ...
    opens br.com.yat.ecosystemcore.modules.empresa.entity to javafx.base;
    opens br.com.yat.ecosystemcore.modules.pessoa.entity to javafx.fxml;
}