...
public class UsuarioController {
    ...
    private void carregarEmpresasDoUsuario(Long usuarioId) {
        AppExecutors.getDatabaseExecutor().execute(() -> {
            try {
                // A assinatura correta agora é apenas (Long)
                ...
                logger.error("Erro ao carregar vínculos da empresa para usuário {}", usuarioId, e);
    ...
    private void carregarDados() {
        AppExecutors.getDatabaseExecutor().execute(() -> {
            try {
                // A assinatura correta agora é sem argumentos
                ...
                Platform.runLater(() -> mostrarAlerta("Erro", "Erro: " + e.getMessage(), Alert.AlertType.ERROR));
            }
        });
    }
