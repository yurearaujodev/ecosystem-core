...
public class App extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        if (ecossistemaPronto) {
            // ⚡ NOVA LINHA DA MIGRAÇÃO: Vincula o cache Caffeine ao escopo global de segurança
            br.com.yat.ecosystemcore.infrastructure.security.CachedSessionSecurityService securityService = 
                new br.com.yat.ecosystemcore.infrastructure.security.CachedSessionSecurityService(
                    new br.com.yat.ecosystemcore.repository.usuario.SessaoUsuarioRepository()
                );
            br.com.yat.ecosystemcore.infrastructure.security.SessionScope.init(securityService);
            br.com.yat.ecosystemcore.infrastructure.security.Sessao.init(securityService);
        }
