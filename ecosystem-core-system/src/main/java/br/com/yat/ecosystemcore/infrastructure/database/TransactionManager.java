...
public final class TransactionManager {
    ...
    /**
     * ⚡ EXCLUSIVO PARA RETORNOS: Executa um bloco que DEVE retornar algum valor (Entidade, Listas, DTOs).
     */
    ...
    /**
     * ⚡ EXCLUSIVO PARA VOID: Executa um bloco transacional que NÃO possui retorno (Updates, Deletes, Inserts).
     * O nome foi alterado para 'executeVoidInTransaction' eliminando qualquer ambiguidade de compilação em Lambdas.
     */
